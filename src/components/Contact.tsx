      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold tracking-[-0.02em] text-[var(--text-primary)] mb-4 leading-tight">
            ...
            <br />
            <span className="text-[var(--text-muted)]">with Iranti?</span>
          </h2>

          <p className="text-[var(--text-secondary)] leading-relaxed mb-8 text-lg">
            We&apos;re looking for design partners — teams building multi-agent
            systems who want to evaluate Iranti before the hosted version ships.
            If you&apos;re running real workloads and have opinions about memory
