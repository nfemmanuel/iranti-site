...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/agent-coordination-layer`,           lastModified: new Date("2026-04-12"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/6k-downloads`,                       lastModified: new Date("2026-04-09"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/github-copilot-memory`,              lastModified: new Date("2026-04-07"), changeFrequency: "monthly", priority: 0.7 },
